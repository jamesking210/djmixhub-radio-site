...
envsubst '${PUBLIC_SITE_URL} ${PUBLIC_SITE_NAME} ${PUBLIC_SITE_TAGLINE} ${PUBLIC_RADIO_BASE_URL} ${PUBLIC_STATION_SHORTCODE} ${PUBLIC_STATION_NAME} ${PUBLIC_NOW_PLAYING_URL} ${PUBLIC_STREAM_URL} ${PUBLIC_MAIN_REPO_URL} ${PUBLIC_AZURACAST_REPO_URL} ${PUBLIC_GITHUB_URL} ${PUBLIC_CONTACT_EMAIL}' \
